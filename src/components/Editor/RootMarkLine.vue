...
export default {
    ...
    mounted () {
        ...
        eventBus.$on('emptyNeedToShow', (data) => {
            this.status = data
        })
    },
    methods: {
        ...
        showLine (isDownward, isRightward) {
            ...
            let canvasStyleData = deepCopy(this.canvasStyleData)
            canvasStyleData.top = 0
            canvasStyleData.left = 0
            const componentStyle = getComponentRotatedStyle(canvasStyleData)
            ...
            const conditions = {
                top: [
                    ...
                    },
                    {
                        ...
                        lineNode: lines.xt[0], // xt
                        line: 'xt',
                        dragShift: 0 - curComponentStyle.height,
                        lineShift: top,
                    },
                    {
                        // 组件与拖拽节点的中间是否对齐
